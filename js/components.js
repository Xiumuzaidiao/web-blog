var mainButton = document.querySelector(".main-button");
			...
			var prosonBox = document.querySelector(".person-box");
			var prosonText = document.querySelector(".person-text");
			...
			mainButton.addEventListener("click", function() {
			  if (isMoved) {
				...
				prosonBox.style.backgroundColor = "rgba(255,255,255, 0.7)";
				prosonText.style.color = "#424242"
				body.style.backgroundColor = "rgba(255,255,255, 1)";
				h1.style.color = "rgba(51,51,51,1)";
			  } else {
				...
				prosonBox.style.backgroundColor = "rgba(51,51,51, 0.7)";
				prosonText.style.color = "#ffffff"
				body.style.backgroundColor = "rgba(51,51,51, 1)";
